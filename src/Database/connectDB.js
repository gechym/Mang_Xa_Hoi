...
const connectDatabase = async () => {
  try {
    ...
    UserInfo.hasMany(UserRelationship, {
      as: 'userSend',
      foreignKey: 'user_send',
    });
    UserRelationship.belongsTo(UserInfo, {
      as: 'userSend',
      foreignKey: 'user_send',
    });
    ...
    UserInfo.hasMany(RepLyComment, {
      as: 'userReplyComment',
      foreignKey: 'user_id',
    });
    RepLyComment.belongsTo(UserInfo, {
      as: 'userReplyComment',
      foreignKey: 'user_id',
    });
    ...
    RepLyComment.hasMany(Like, {
      as: 'repLyCommentLike',
      foreignKey: 'reply_comment_id',
    });
    Like.belongsTo(RepLyComment, {
      as: 'repLyCommentLike',
      foreignKey: 'reply_comment_id',
    });
